...
impl BuildInfo {
    pub fn new() -> BuildInfo {
        ...
        BuildInfo {
            ...
            git_commit: String::from(r"0e243c21842679c82a514cfd9deb03312c25441d"),
            git_branch: String::from(r"oklab_qoi"),
            ...
            build_date: String::from(r"2023-12-14 17:58:20.128050726+01:00"),
        }
        //@@AUTO GENERATE END@@
    }
}
