...
// benchmarking proofed bigmagic is not faster than std
///// returns -x
/////
///// inspired by Creel: <https://youtu.be/ReTetN51r7A?si=hSNzsPFMN_Pe5kgj&t=201>
/////
...
// benchmarking proofed, newton step makes this substentially slower than std. removing the newton
// step substentially decreased accuracy
///// returns sqrt(x)
/////
///// max error: ~ 0.03925;
