...
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_InitForOpenGL@@YA_NPEAUSDL_Window@@PEAX@Z"]
...
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_InitForVulkan@@YA_NPEAUSDL_Window@@@Z"]
    pub fn ImGui_ImplSDL2_InitForVulkan(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_InitForD3D@@YA_NPEAUSDL_Window@@@Z"]
    pub fn ImGui_ImplSDL2_InitForD3D(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_InitForMetal@@YA_NPEAUSDL_Window@@@Z"]
    pub fn ImGui_ImplSDL2_InitForMetal(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_InitForSDLRenderer@@YA_NPEAUSDL_Window@@PEAUSDL_Renderer@@@Z"]
...
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_InitForOther@@YA_NPEAUSDL_Window@@@Z"]
    pub fn ImGui_ImplSDL2_InitForOther(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_Shutdown@@YAXXZ"]
    pub fn ImGui_ImplSDL2_Shutdown();
}
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_NewFrame@@YAXXZ"]
    pub fn ImGui_ImplSDL2_NewFrame();
}
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_ProcessEvent@@YA_NPEBTSDL_Event@@@Z"]
    pub fn ImGui_ImplSDL2_ProcessEvent(event: *const SDL_Event) -> bool;
}
pub const ImGui_ImplSDL2_GamepadMode_ImGui_ImplSDL2_GamepadMode_AutoFirst:
    ImGui_ImplSDL2_GamepadMode = 0;
pub const ImGui_ImplSDL2_GamepadMode_ImGui_ImplSDL2_GamepadMode_AutoAll:
    ImGui_ImplSDL2_GamepadMode = 1;
pub const ImGui_ImplSDL2_GamepadMode_ImGui_ImplSDL2_GamepadMode_Manual: ImGui_ImplSDL2_GamepadMode =
    2;
pub type ImGui_ImplSDL2_GamepadMode = ::std::os::raw::c_int;
extern "C" {
    #[link_name = "\u{1}?ImGui_ImplSDL2_SetGamepadMode@@YAXW4ImGui_ImplSDL2_GamepadMode@@PEAPEAU_SDL_GameController@@H@Z"]
    pub fn ImGui_ImplSDL2_SetGamepadMode(
        mode: ImGui_ImplSDL2_GamepadMode,
        manual_gamepads_array: *mut *mut _SDL_GameController,
        manual_gamepads_count: ::std::os::raw::c_int,
    );
}
#[repr(C)]
#[derive(Debug, Copy, Clone)]
