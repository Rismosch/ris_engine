...
extern "C" {
    #[link_name = "\u{1}_Z28ImGui_ImplSDL2_InitForOpenGLP10SDL_WindowPv"]
...
extern "C" {
    #[link_name = "\u{1}_Z28ImGui_ImplSDL2_InitForVulkanP10SDL_Window"]
    pub fn ImGui_ImplSDL2_InitForVulkan(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_Z25ImGui_ImplSDL2_InitForD3DP10SDL_Window"]
    pub fn ImGui_ImplSDL2_InitForD3D(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_Z27ImGui_ImplSDL2_InitForMetalP10SDL_Window"]
    pub fn ImGui_ImplSDL2_InitForMetal(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_Z33ImGui_ImplSDL2_InitForSDLRendererP10SDL_WindowP12SDL_Renderer"]
...
extern "C" {
    #[link_name = "\u{1}_Z27ImGui_ImplSDL2_InitForOtherP10SDL_Window"]
    pub fn ImGui_ImplSDL2_InitForOther(window: *mut SDL_Window) -> bool;
}
extern "C" {
    #[link_name = "\u{1}_Z23ImGui_ImplSDL2_Shutdownv"]
    pub fn ImGui_ImplSDL2_Shutdown();
}
extern "C" {
    #[link_name = "\u{1}_Z23ImGui_ImplSDL2_NewFramev"]
    pub fn ImGui_ImplSDL2_NewFrame();
}
extern "C" {
    #[link_name = "\u{1}_Z27ImGui_ImplSDL2_ProcessEventPK9SDL_Event"]
...
pub const ImGui_ImplSDL2_GamepadMode_ImGui_ImplSDL2_GamepadMode_Manual: ImGui_ImplSDL2_GamepadMode =
    2;
pub type ImGui_ImplSDL2_GamepadMode = ::std::os::raw::c_uint;
extern "C" {
    #[link_name = "\u{1}_Z29ImGui_ImplSDL2_SetGamepadMode26ImGui_ImplSDL2_GamepadModePP19_SDL_GameControlleri"]
