...
extern "C" {
    pub fn at_quick_exit(arg1: ::std::option::Option<extern "C" fn()>) -> ::std::os::raw::c_int;
}
...
pub type ImGuiContextHookCallback =
    ::std::option::Option<extern "C" fn(ctx: *mut ImGuiContext, hook: *mut ImGuiContextHook)>;
...
pub struct ImGuiContext {
    ...
    pub DockNodeWindowMenuHandler: ::std::option::Option<
        extern "C" fn(ctx: *mut ImGuiContext, node: *mut ImGuiDockNode, tab_bar: *mut ImGuiTabBar),
    >,
...
pub struct ImFontBuilderIO {
    pub FontBuilder_Build: ::std::option::Option<extern "C" fn(atlas: *mut ImFontAtlas) -> bool>,
}
#[allow(clippy::unnecessary_operation, clippy::identity_op)]
const _: () = {
