...
pub const IMGUI_CONFIG_FLAGS_NAV_ENABLE_KEYBOARD: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_NavEnableKeyboard;
pub const IMGUI_CONFIG_FLAGS_NAV_ENABLE_GAMEPAD: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_NavEnableGamepad;
...
pub const IMGUI_CONFIG_FLAGS_NO_MOUSE_CURSOR_CHANGE: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_NoMouseCursorChange;
...
pub const IMGUI_CONFIG_FLAGS_DOCKING_ENABLE: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_DockingEnable;
pub const IMGUI_CONFIG_FLAGS_VIEWPORTS_ENABLE: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_ViewportsEnable;
pub const IMGUI_CONFIG_FLAGS_DPI_ENABLE_SCALE_VIEWPORTS: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_DpiEnableScaleViewports;
pub const IMGUI_CONFIG_FLAGS_DPI_ENABLE_SCALE_FONTS: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_DpiEnableScaleFonts;
...
pub const IMGUI_CONFIG_FLAGS_IS_TOUCH_SCREEN: i32 =
    sys::ImGuiConfigFlags__ImGuiConfigFlags_IsTouchScreen;
